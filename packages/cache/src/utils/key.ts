...
export const makeCacheKey = (...parts: [first: string, ...rest: string[]]): CacheKey => {
  if (parts[0] === "ol") {
    logger.error("Invalid Cache key: Do not include 'ol' prefix, it's added automatically");
    throw new Error("Invalid Cache key: Do not include 'ol' prefix, it's added automatically");
  }
