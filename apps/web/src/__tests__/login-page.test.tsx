...
describe("LoginPage", () => {
	...
	// This used to assert the opposite - that no reset link was offered - while
	// /auth/forgot-password was a 501 stub, with a note to reverse it in the same
	// change that implemented the API. This is that change.
	it("offers password reset, which the API now serves", () => {
		renderLogin();
