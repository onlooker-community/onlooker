...
export const assayer: PluginData = {
  ...
  tables: [
    ...
    },
    {
      ...
      rows: [
        ...
        ['generic', 'Catch-all for verifiable success claims that do not fit the above'],
      ],
    },
  ],
  ...
  events: [
    ...
    },
    {
      ...
      keyFields: 'tallies, verdict (clean | contradictions_found | nothing_to_verify), duration_ms',
    },
  ],
