...
export const counsel: PluginData = {
  ...
  name: 'Counsel',
  version: '0.1.0',
  tagline: 'Your observability stack has been watching. Now it has something to say.',
  category: 'analysis',
  ...
  events: [
    {
      ...
      keyFields: 'period_start, period_end, recommendation_count, sources_consulted',
    },
  ],
  ...
  tags: ['observability', 'synthesis', 'coaching', 'recommendations', 'patterns', 'weekly', 'analysis'],
