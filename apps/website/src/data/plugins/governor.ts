...
export const governor: PluginData = {
  ...
  tables: [
    {
      ...
      rows: [
        ['soft', 'Always allows; emits event with decision and projected spend'],
        ['hard', 'Blocks when budget is exceeded; hard-stop ceiling always enforced'],
      ],
    },
  ],
  ...
  events: [
    {
      ...
      keyFields: 'decision, consumed_tokens, estimated_tokens, budget_tokens, enforcement',
    },
  ],
  ...
  tags: ['budget', 'tokens', 'cost', 'governance', 'safety', 'limits', 'subagents', 'Task'],
};
