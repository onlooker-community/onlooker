	...
	tables: [
		{
			...
			rows: [
				[
					"contradiction",
					"Two rules that cannot both be satisfied simultaneously",
				],
				[
					"dead_rule",
					"A rule fully subsumed by a more specific rule elsewhere",
				],
				[
					"stale_ref",
					"A reference to a file path, tool, or command that no longer exists",
				],
				[
					"scope_collision",
