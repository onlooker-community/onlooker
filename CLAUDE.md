...
### Edit tracked files with the file tools, not the shell

Use `Edit`, `Write`, or `MultiEdit` to change tracked files. The shell stays
right for everything else — running commands, searching, git — and for scratch
